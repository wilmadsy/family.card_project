...
<body>
    <div class="container">
        <div class="card">
            ...
            <div class="card-body">
               <form action="{{ route('data_m.update', $fmember->id) }}" method="POST">
                @csrf
                @method('PUT')
                    ...
                    <div class="form-section">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="hidden" class="form-control" id="familycard_id" name="familycard_id"  value="{{ old('familycard_id', $fmember->familycard_id) }}" required>
                            </div>
                             <div class="col-md-6">
                                <label for="full_name" class="form-label required-field">Nama Lengkap</label>
                                <input type="text" class="form-control" id="full_name" name="full_name" value="{{ old('full_name', $fmember->full_name) }}" required>
                            </div>
                             <div class="col-md-6">
                                <label for="pin" class="form-label required-field">NIK</label>
                                <input type="text" class="form-control" id="pin" name="pin" value="{{ old('pin', $fmember->pin) }}" required>
                            </div>
                             <div class="col-md-4">
                                <label for="gender" class="form-label required-field">Jenis Kelamin</label>
                                <select class="form-select" id="gender" name="gender" value="{{ old('gender', $fmember->gender) }}" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="place_of_birth" name="place_of_birth" value="{{ old('place_of_birth', $fmember->place_of_birth) }}" required>
                            </div>
                            <div class="col-md-4">
                                <label for="date_of_birth" class="form-label required-field">Tanggal Lahir</label>
                                <input type="date" class="form-control" id="date_of_birth" name="date_of_birth" value="{{ old('date_of_birth', $fmember->date_of_birth) }}" required>
                            </div>
                            <div class="col-md-4">
                                <label for="education" class="form-label required-field">Pendidikan</label>
                                <input type="text" class="form-control" id="education" name="education" value="{{ old('education', $fmember->education) }}" required>
                            </div>
                            <div class="col-md-4">
